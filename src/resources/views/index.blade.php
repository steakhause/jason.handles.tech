<x-layout>
    ...
    <!--ABOUT ME SECTION-->
    <x-default-section id="about-me" h1="JASON RYSZKA" h2="Full Stack Developer" h3="Maricopa, Arizona" :quote="['Great things are done by a series of small things brought together.','Vincent Van Gogh']">
            ...
            <article>
                <header>
                    ...
                    <p class="text-sm text-stone-400"><strong>Clever Investor</strong> - Tempe, AZ<br>
                        <time class="text-xs text-stone-200" datetime="2015-08">August 2015</time> - <time class="text-xs text-stone-200" datetime="2025-04">April 2025</time>
                    </p>
                </header>
                <ul class="mt-4 list-disc pl-6 text-base">
                    <li>Promoted from Level 1 Support to CTO, replacing multiple third-party vendors by building robust in-house development and IT operations.</li>
                    ...
                    <li>Managed all aspects of IT infrastructure across multiple locations — from structured cabling and VoIP systems to servers, CRMs, asset management, and building security.</li>
                    <li>Led development and support teams, collaborating with other departments to identify bottlenecks and deploy automated solutions that increased efficiency and ROI.</li>
                    <li>Oversaw technical compliance, documentation, and system interoperability across departments.</li>
                    <li>Administered and customized CRM systems (Salesforce, Keap, GoHighLevel, HubSpot, Maropost), integrated third-party APIs, and executed high-volume marketing automations.</li>
                    <li>Designed and coded custom utilities, integrations, and browser extensions to streamline employee workflows.</li>
                </ul>
            </article>
        </section>
            ...
            <article>
                <header>
                    ...
                    <p class="text-sm text-stone-400"><strong>Black Box Networks</strong> - Chandler, AZ<br>
                        <time class="text-xs text-stone-200" datetime="2015-01">January 2015</time> - <time class="text-xs text-stone-200" datetime="2025-08">August 2015</time>
                    </p>
                </header>
                <ul class="mt-4 list-disc pl-6 text-base">
                    <li>Installed and maintained Ethernet, coax, and fiber optic cabling in semiconductor environments (Intel & Motorola).</li>
                    <li>Configured and tested switches, routers, and wireless access points in cleanroom data centers.</li>
            ...
            <article>
                <header>
                    ...
                    <p class="text-sm text-stone-400"><strong>Cox Communications</strong> - Tempe, AZ<br>
                        <time class="text-xs text-stone-200" datetime="2008-04">April 2008</time> - <time class="text-xs text-stone-200" datetime="2015-01">January 2015</time>
                    </p>
                </header>
                <ul class="mt-4 list-disc pl-6 text-base">
                    <li>Installed and repaired residential and business video/data services in a HFC environment.</li>
                    <li>Developed deep knowledge of IP-based systems and networking through training and real-world experience.</li>
                    <li>Utilized advanced NOC toolset for monitoring and troubleshooting high availability data networks</li>
                </ul>
            </article>
        </section>
            ...
            <article>
                <header>
                    ...
                    <p class="text-sm text-stone-400"><strong>AT&T</strong> - Multiple Locations<br>
                        <time class="text-xs text-stone-200" datetime="2006">2006</time> - <time class="text-xs text-stone-200" datetime="2008">2008</time>
                    </p>
                </header>
                <ul class="mt-4 list-disc pl-6 text-base">
                    <li>Maintained voice and data services for business and residential clients including voice, T1, ISDN, MPLS, Centrex, DSL, and Fiber circuits.</li>
                    <li>Worked end-to-end from central office hardware to customer endpoint integration.</li>
                    <li>Performed maintenance and repair on Lightspan, DSLAM, and Pair gain systems in both above ground cabinets and CEVs</li>
                    <li>Worked in a broad range of secure facilities requiring various levels of government clearance</li>
                </ul>
            </article>
        </section>
    ...
    <x-default-section id="education" h1="Education" class="bg-stone-700">
